...
public class ConfirmDeleteDialog extends javax.swing.JDialog {
     ...
     */
    public ConfirmDeleteDialog(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("¿Seguro que quiere eliminar su cuenta?");
    ...
    private void btnYesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnYesActionPerformed
        ProfileDialog profileDialog = (ProfileDialog)this.getParent();
        profileDialog.setConfirmDelete(true);
        this.setVisible(false);
    }//GEN-LAST:event_btnYesActionPerformed

    private void bntNoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntNoActionPerformed
        ProfileDialog profileDialog = (ProfileDialog)this.getParent();
        profileDialog.setConfirmDelete(false);
        this.setVisible(false);
